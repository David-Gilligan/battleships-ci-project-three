...
def RunGame(): 
  ...
  while turns > 0:
    ...
    if computer_board.board[user_x_row][user_y_column] == "X":
      print("Great shot! You sunk the enemie's battleship!")
      user_guess_board.board[user_x_row][user_y_column] = "X"
    else:
      print("Wayward shot! No battleship hit...")
      user_guess_board.board[user_x_row][user_y_column] = "-"
    #check for win or lose
    if Battleship.count_hit_ships(user_guess_board) == 5:
      print("Congratulations, you win! All of the enemies battleships have been sunk!")
      break
    else:
      turns -= 1
      print(f"You have {turns} turns remaining")
      if turns == 0:
        print("Unlucky, you lose! Unfortunately you have run out of ammo")
        GameBoard.print_board(user_guess_board)
        break
